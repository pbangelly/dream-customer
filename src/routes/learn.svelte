...
<div class="relative bg-white">
    <div class="absolute inset-0" aria-hidden="true">
      <div class="absolute inset-y-0 right-0 w-1/2 bg-red-700"></div>
    </div>
    <div class="relative max-w-7xl mx-auto lg:px-8 lg:grid lg:grid-cols-2">
      <div class="bg-white py-16 px-4 sm:py-24 sm:px-6 lg:px-0 lg:pr-8">
        <div class="max-w-lg mx-auto lg:mx-0">
          ...
          <dl class="mt-12 space-y-10">
            <div class="relative">
              <dt>
                <div class="absolute h-12 w-12 flex items-center justify-center bg-red-500 rounded-md">
      ...
      <div class="bg-red-700 py-16 px-4 sm:py-24 sm:px-6 lg:bg-none lg:px-0 lg:pl-8 lg:flex lg:items-center lg:justify-end">
        <div class="max-w-lg mx-auto w-full space-y-8 lg:mx-0">
          <div>
            <h2 class="sr-only">Price</h2>
            <p class="relative grid grid-cols-2">
              <span class="flex flex-col text-center">
                <span class="text-5xl font-extrabold text-white tracking-tight">$997</span>
                <span class="mt-2 text-base font-medium text-red-200">Setup fee</span>
              ...
              <span>
                <span class="flex flex-col text-center">
                  <span class="text-5xl font-extrabold text-white tracking-tight">$147</span>
                  <span class="mt-2 text-base font-medium text-red-200">Per month</span>
                </span>
              </span>
            </p>
          </div>
          <ul class="rounded overflow-hidden grid gap-px sm:grid-cols-2">
            <li class="bg-red-800 bg-opacity-50 py-4 px-4 flex items-center space-x-3 text-base text-white">
          ...
          <a href="#" class="bg-white border border-transparent rounded-md w-full px-8 py-4 flex items-center justify-center text-lg leading-6 font-medium text-red-600 hover:bg-red-50 md:px-10">
            Get started today
          </a>
          <a href="#" class="block text-center text-base font-medium text-red-200 hover:text-white">
